...
export default function AvailabilityLocation() {
  return (
    <section className="relative py-12 sm:py-20 px-5 sm:px-8 bg-black border-t border-white/10">
      <div className="container-custom max-w-7xl mx-auto">
        <div className="grid grid-cols-2 gap-6 sm:gap-12 md:gap-24">
          {/* Availability */}
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm sm:text-lg md:text-xl text-white">Available Today</p>
            </div>
          </div>
